...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.tableAccountAcquisitionDate = "ai.table.accountAcquisitionDate";
            this.tableAccountId = "ai.table.accountId";
            this.tableAgent = "ai.table.tableAgent";
            this.tableId = "ai.table.id";
            this.tableStoreRegion = "ai.table.storeRegion";
            this.tableAuthUserId = "ai.table.authUserId";
            this.tableAnonymousUserAcquisitionDate = "ai.table.anonUserAcquisitionDate";
            this.tableAuthenticatedUserAcquisitionDate = "ai.table.authUserAcquisitionDate";
    ...
    (function (ApplicationInsights) {
        var SamplingScoreGenerator = (function () {
            ...
            SamplingScoreGenerator.getScore = function (envelope) {
                ...
                var score = 0;
                if (envelope.tags[tagKeys.tableId]) {
                    score = SamplingScoreGenerator.getSamplingHashCode(envelope.tags[tagKeys.tableId]) / SamplingScoreGenerator.INT_MAX_VALUE;
                }
        ...
        (function (Context) {
            ...
            var User = (function () {
                function User(accountId) {
                    var cookie = ApplicationInsights.Util.getCookie(User.tableCookieName);
                    if (cookie) {
                    ...
                    if (!this.id) {
                        ...
                        ApplicationInsights.Util.setCookie(User.tableCookieName, newCookie.join(User.cookieSeparator) + ';expires=' + date.toUTCString());
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth table context failed. " + "User auth/account id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
        ...
        var TelemetryContext = (function () {
            function TelemetryContext(config) {
                ...
                if (typeof window !== 'undefined') {
                    ...
                    this.table = new ApplicationInsights.Context.User(config.accountId());
            ...
            TelemetryContext.prototype._track = function (envelope) {
                ...
                this._applyUserContext(envelope, this.table);
            ...
            TelemetryContext.prototype._applyUserContext = function (envelope, tableContext) {
                if (tableContext) {
                    var tagKeys = new AI.ContextTagKeys();
                    if (typeof tableContext.accountAcquisitionDate === "string") {
                        envelope.tags[tagKeys.tableAccountAcquisitionDate] = tableContext.accountAcquisitionDate;
                    }
                    if (typeof tableContext.accountId === "string") {
                        envelope.tags[tagKeys.tableAccountId] = tableContext.accountId;
                    }
                    if (typeof tableContext.agent === "string") {
                        envelope.tags[tagKeys.tableAgent] = tableContext.agent;
                    }
                    if (typeof tableContext.id === "string") {
                        envelope.tags[tagKeys.tableId] = tableContext.id;
                    }
                    if (typeof tableContext.authenticatedId === "string") {
                        envelope.tags[tagKeys.tableAuthUserId] = tableContext.authenticatedId;
                    }
                    if (typeof tableContext.storeRegion === "string") {
                        envelope.tags[tagKeys.tableStoreRegion] = tableContext.storeRegion;
                    }
                }
            };
    ...
    (function (ApplicationInsights) {
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    this.context.table.setAuthenticatedUserContext(authenticatedUserId, accountId);
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth table context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    this.context.table.clearAuthenticatedUserContext();
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Clearing auth table context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
